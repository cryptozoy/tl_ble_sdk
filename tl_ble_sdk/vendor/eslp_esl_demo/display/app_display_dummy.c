...
static u8 app_display_dummy_buffer[DISPLAY_DUMMY_IMAGE_SIZE];
...
static bool app_display_dummy_get_buffer(u8 **buffer_ptr)
{
    *buffer_ptr = app_display_dummy_buffer;
...
static const app_display_iface_t app_display_dummy_cb = {
    ...
    .get_buffer = app_display_dummy_get_buffer,
};
