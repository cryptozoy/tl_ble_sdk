 ...
 * @brief   L2CAP RX Data buffer for ACL Central
 */
 u8 app_cen_l2cap_rx_buf[ACL_CENTRAL_MAX_NUM * CENTRAL_L2CAP_BUFF_SIZE];
 ...
 *          if GATT server on ACL Central not used, this buffer can be saved.
 */
 u8 app_cen_l2cap_tx_buf[ACL_CENTRAL_MAX_NUM * CENTRAL_L2CAP_BUFF_SIZE];


/**
 * @brief   L2CAP RX Data buffer for ACL Peripheral
 */
 u8 app_per_l2cap_rx_buf[ACL_PERIPHR_MAX_NUM * PERIPHR_L2CAP_BUFF_SIZE];
