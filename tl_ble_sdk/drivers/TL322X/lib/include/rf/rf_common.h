 ...
 *                                         RF global constants                                                        *
 *********************************************************************************************************************/
extern volatile rf_power_level_e rf_power_Level_list[60]; //BLE SDK use: in IRQ
 ...
 * @return      none.
 */
static _attribute_ram_code_sec_ inline  void rf_set_crc_config(const rf_crc_config_t *config)
{
